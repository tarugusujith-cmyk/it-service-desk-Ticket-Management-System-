      ...
      <div className="flex flex-1 items-center justify-center bg-ink-50 px-6 py-12">
        <div className="w-full max-w-sm">
          <div className="mb-8 md:hidden">
            <div className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-md bg-steel-500 font-mono text-sm font-semibold text-white">DF</div>
              <span className="text-lg font-semibold text-ink-800">DeskFlow</span>
            </div>
          </div>

          <h1 className="text-xl font-semibold text-ink-800">Sign in to your desk</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-ink-200 bg-white px-3 py-2 text-sm text-ink-700 focus:border-steel-400 focus:outline-none focus:ring-2 focus:ring-steel-100"
              />
            </div>
            <div>
            ...
            <div className="space-y-1.5">
              {demoAccounts.map((acc) => (
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-md px-2 py-1.5 text-left text-xs hover:bg-ink-50"
                >
                  <span className="font-medium text-ink-600">{acc.role}</span>
                  <span className="font-mono text-ink-400">{acc.email}</span>
                </button>
              ))}
            </div>
          </div>
