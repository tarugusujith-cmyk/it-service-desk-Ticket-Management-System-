...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-ink-800">Admin overview</h2>
        <p className="text-sm text-ink-400">A full picture of every ticket moving through the desk.</p>
      </div>
      ...
      <div>
        <h3 className="mb-3 text-sm font-semibold text-ink-700">Recent tickets</h3>
