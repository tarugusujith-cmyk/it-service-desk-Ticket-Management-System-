  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-ink-800">My support space</h2>
          <p className="text-sm text-ink-400">Track requests you've raised with IT.</p>
        </div>
        <Link
          to="/tickets/new"
      ...
      <div>
        <h3 className="mb-3 text-sm font-semibold text-ink-700">My tickets</h3>
