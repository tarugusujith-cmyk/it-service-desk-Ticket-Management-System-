...
export default function CreateTicket() {
  ...
  return (
    <div className="max-w-2xl">
      <h2 className="mb-1 text-lg font-semibold text-ink-800">Create a support ticket</h2>
      <p className="mb-5 text-sm text-ink-400">Tell us what's going on and we'll route it to the right team.</p>
