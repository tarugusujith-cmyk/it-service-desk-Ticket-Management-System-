...
export default function EditTicket() {
  ...
  return (
    <div className="max-w-2xl">
      <h2 className="mb-1 text-lg font-semibold text-ink-800">Edit ticket {ticket.ticketNumber}</h2>
      <p className="mb-5 text-sm text-ink-400">Update the details below.</p>
