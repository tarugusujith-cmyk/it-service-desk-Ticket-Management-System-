...
export default function TicketDetails() {
  ...
  async function handleResolve(resolutionText: string) {
    ...
    try {
      // Add both activities to the ticket correctly.
      const ticketWithResolutionActivity: Ticket = {
        ...ticket,
        activity: appendActivity(ticket, 'Resolution added'),
      }
      ...
      showToast(
        err instanceof Error ? err.message : 'Could not resolve ticket.',
        'error'
      )
    }
  }
  ...
  async function handleAssign(agent: {
    ...
    try {
      ...
      showToast(
        err instanceof Error ? err.message : 'Could not assign ticket.',
        'error'
      )
    }
  }
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <h2 className="mt-1 text-xl font-semibold text-ink-800">
            {ticket.subject}
          </h2>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {deleteAllowed && (
            <button
              ...
              className="rounded-md border border-brick-200 px-3 py-1.5 text-sm font-medium text-brick-500 hover:bg-brick-50"
            >
              Delete
            </button>
          )}
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          {ticket.resolution && (
            <section className="rounded-lg border border-moss-400/30 bg-moss-50 p-5">
              <h3 className="mb-2 text-sm font-semibold text-moss-600">
                Resolution
              </h3>
      ...
      >
        <p className="text-sm text-ink-600">
          ...
          <span className="font-medium">{ticket.ticketNumber}</span> and its
