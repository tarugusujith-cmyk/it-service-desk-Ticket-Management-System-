  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-semibold text-ink-800">Ticket categories</h2>
          <p className="text-sm text-ink-400">{categories.length} categor{categories.length !== 1 ? 'ies' : 'y'}</p>
        </div>
